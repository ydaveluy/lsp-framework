...
inline constexpr std::string_view ProtocolVersionStr{"3.18.0"};
...
using CodeActionTagEnum = Enumeration<CodeActionTag, uint>;
template<>
...
using TraceValueEnum = Enumeration<TraceValue, String>;
template<>
...
using LanguageKindEnum = Enumeration<LanguageKind, String>;
template<>
...
using ApplyKindEnum = Enumeration<ApplyKind, uint>;
template<>
 ...
 * @since 3.17.0
 */
using TextDocumentFilter = OneOf<TextDocumentFilterLanguage, TextDocumentFilterScheme, TextDocumentFilterPattern>;
 ...
 * @since 3.17.0
 */
using NotebookDocumentFilter = OneOf<NotebookDocumentFilterNotebookType, NotebookDocumentFilterScheme, NotebookDocumentFilterPattern>;
...
struct SemanticTokensOptions{
	 ...
	 */
	Opt<OneOf<bool, SemanticTokensFullDelta>> full = {};
};
...
struct TextDocumentEdit{
	 ...
	 * client capability.
	 */
	Array<OneOf<TextEdit, AnnotatedTextEdit, SnippetTextEdit>> edits;
};
...
struct Diagnostic{
	 ...
	 */
	OneOf<String, MarkupContent> message;
	/*
...
struct NotebookDocumentFilterWithNotebook{
	 ...
	 */
	Opt<Array<NotebookCellLanguage>> cells = {};
};
...
struct NotebookDocumentFilterWithCells{
	 ...
	 * The cells of the matching notebook to be synced.
	 */
	Array<NotebookCellLanguage> cells;
	/*
	 * The notebook to be synced If a string
	 * value is provided it matches against the
	 * notebook type. '*' matches every notebook.
...
struct NotebookDocumentSyncOptions{
	 ...
	 */
	Array<OneOf<NotebookDocumentFilterWithNotebook, NotebookDocumentFilterWithCells>> notebookSelector;
	/*
 ...
 */
using TextDocumentContentChangeEvent = OneOf<TextDocumentContentChangePartial, TextDocumentContentChangeWholeDocument>;
...
struct NotebookDocumentCellChanges{
	 ...
	 * remove cells.
	 */
	Opt<NotebookDocumentCellChangeStructure> structure = {};
	/*
	 ...
	 */
	Opt<Array<NotebookDocumentCellContentChanges>> textContent = {};
};
...
struct NotebookDocumentChangeEvent{
	 ...
	 * Changes to cells
	 */
	Opt<NotebookDocumentCellChanges> cells = {};
};
...
struct WorkspaceEditClientCapabilities{
	 ...
	 * @since 3.16.0
	 */
	Opt<ChangeAnnotationsSupportOptions> changeAnnotationSupport = {};
	/*
	 * Whether the client supports `WorkspaceEditMetadata` in `WorkspaceEdit`s.
	 * 
	 * @since 3.18.0
	 */
	Opt<bool> metadataSupport = {};
	/*
	 * Whether the client supports snippets as text edits.
	 * 
	 * @since 3.18.0
	 */
	Opt<bool> snippetEditSupport = {};
};
...
struct WorkspaceSymbolClientCapabilities{
	 ...
	 */
	Opt<ClientSymbolKindOptions> symbolKind = {};
	/*
	 ...
	 * @since 3.16.0
	 */
	Opt<ClientSymbolTagOptions> tagSupport = {};
	/*
	 ...
	 * @since 3.17.0
	 */
	Opt<ClientSymbolResolveOptions> resolveSupport = {};
};
...
struct WorkspaceClientCapabilities{
	 ...
	 * @since 3.18.0
	 */
	Opt<TextDocumentContentClientCapabilities> textDocumentContent = {};
};
...
struct ClientCompletionItemOptions{
	 ...
	 * @since 3.15.0
	 */
	Opt<CompletionItemTagOptions> tagSupport = {};
	/*
	 ...
	 * @since 3.16.0
	 */
	Opt<ClientCompletionItemResolveOptions> resolveSupport = {};
	/*
	 ...
	 * @since 3.16.0
	 */
	Opt<ClientCompletionItemInsertTextModeOptions> insertTextModeSupport = {};
	/*
...
struct CompletionClientCapabilities{
	 ...
	 * capabilities.
	 */
	Opt<ClientCompletionItemOptions> completionItem = {};
	/*
	 * The client supports the following completion item kinds.
	 */
	Opt<ClientCompletionItemOptionsKind> completionItemKind = {};
	/*
	 ...
	 * @since 3.17.0
	 */
	Opt<CompletionListCapabilities> completionList = {};
};
...
struct ClientSignatureInformationOptions{
	 ...
	 */
	Opt<ClientSignatureParameterInformationOptions> parameterInformation = {};
	/*
	 ...
	 * @since 3.18.0
	 */
	Opt<bool> noActiveParameterSupport = {};
};
...
struct SignatureHelpClientCapabilities{
	 ...
	 * specific properties.
	 */
	Opt<ClientSignatureInformationOptions> signatureInformation = {};
	/*
	 * The client supports to send additional context information for a
...
struct CodeActionTagOptions{
	 ...
	 * The tags supported by the client.
	 */
	Array<CodeActionTagEnum> valueSet;
};
...
struct CodeActionClientCapabilities{
	 ...
	 * @since 3.8.0
	 */
	Opt<ClientCodeActionLiteralOptions> codeActionLiteralSupport = {};
	/*
	 ...
	 * @since 3.16.0
	 */
	Opt<ClientCodeActionResolveOptions> resolveSupport = {};
	/*
	 ...
	 * @since 3.18.0
	 */
	Opt<CodeActionTagOptions> tagSupport = {};
};
...
struct CodeLensClientCapabilities{
	 ...
	 * @since 3.18.0
	 */
	Opt<ClientCodeLensResolveOptions> resolveSupport = {};
};
...
struct FoldingRangeClientCapabilities{
	 ...
	 * @since 3.17.0
	 */
	Opt<ClientFoldingRangeKindOptions> foldingRangeKind = {};
	/*
	 * Specific options for the folding range.
	 * 
	 * @since 3.17.0
	 */
	Opt<ClientFoldingRangeOptions> foldingRange = {};
};
...
struct DiagnosticsCapabilities{
	 ...
	 * @since 3.15.0
	 */
	Opt<ClientDiagnosticsTagOptions> tagSupport = {};
	/*
...
/*
 * ClientSemanticTokensRequestOptionsRange
 */
struct ClientSemanticTokensRequestOptionsRange{
};
...
struct ClientSemanticTokensRequestOptions{
	 ...
	 * the server provides a corresponding handler.
	 */
	Opt<OneOf<bool, ClientSemanticTokensRequestOptionsRange>> range = {};
	/*
	 * The client will send the `textDocument/semanticTokens/full` request if
	 * the server provides a corresponding handler.
	 */
	Opt<OneOf<bool, ClientSemanticTokensRequestFullDelta>> full = {};
};
...
struct InlayHintClientCapabilities{
	 ...
	 * hint.
	 */
	Opt<ClientInlayHintResolveOptions> resolveSupport = {};
};
...
struct TextDocumentClientCapabilities{
	 ...
	 * @since 3.18.0
	 */
	Opt<TextDocumentFilterClientCapabilities> filters = {};
	/*
...
struct ShowMessageRequestClientCapabilities{
	 ...
	 */
	Opt<ClientShowMessageActionItemOptions> messageActionItem = {};
};
...
struct GeneralClientCapabilities{
	 ...
	 * @since 3.17.0
	 */
	Opt<StaleRequestSupportOptions> staleRequestSupport = {};
	/*
	 * Client capabilities specific to regular expressions.
	 * 
	 * @since 3.16.0
...
struct CompletionOptions{
	 ...
	 * @since 3.17.0
	 */
	Opt<ServerCompletionItemOptions> completionItem = {};
};
...
struct CodeActionOptions{
	 ...
	 * @since 3.18.0
	 */
	Opt<Array<CodeActionKindDocumentation>> documentation = {};
	/*
	 * The server provides support to resolve additional
...
struct WorkspaceOptions{
	 ...
	 * @since 3.18.0
	 */
	Opt<OneOf<TextDocumentContentOptions, TextDocumentContentRegistrationOptions>> textDocumentContent = {};
};
...
struct ServerCapabilities{
	 ...
	 */
	Opt<WorkspaceOptions> workspace = {};
	/*
...
struct CompletionItemDefaults{
	 ...
	 * @since 3.17.0
	 */
	Opt<OneOf<Range, EditRangeWithInsertReplace>> editRange = {};
	/*
...
struct CompletionItemApplyKinds{
	 ...
	 * @since 3.18.0
	 */
	Opt<ApplyKindEnum> commitCharacters = {};
	/*
...
struct CompletionList{
	 ...
	 * @since 3.17.0
	 */
	Opt<CompletionItemDefaults> itemDefaults = {};
	/*
	 * Specifies how fields from a completion item should be combined with those
	 * from `completionList.itemDefaults`.
	 * 
	 ...
	 * @since 3.18.0
	 */
	Opt<CompletionItemApplyKinds> applyKind = {};
};
 ...
 * @deprecated use MarkupContent instead.
 */
using MarkedString = OneOf<String, MarkedStringWithLanguage>;
...
struct SignatureInformation{
	 ...
	 * @since 3.16.0
	 */
	Opt<NullOr<uint>> activeParameter = {};
};
...
struct CodeAction{
	 ...
	 * @since 3.18.0
	 */
	Opt<Array<CodeActionTagEnum>> tags = {};
};
...
struct WorkspaceSymbol : BaseSymbolInformation{
	 ...
	 */
	OneOf<Location, LocationUriOnly> location;
	/*
...
struct ApplyWorkspaceEditParams{
	 ...
	 * @since 3.18.0
	 */
	Opt<WorkspaceEditMetadata> metadata = {};
};
 ...
 * @since 3.18.1
 */
using DocumentDiagnosticReportProgress = OneOf<DocumentDiagnosticReport, DocumentDiagnosticReportPartialResult>;

/*
 * PrepareRenameResult
 */
using PrepareRenameResult = OneOf<Range, PrepareRenamePlaceholder, PrepareRenameDefaultBehavior>;
...
/*
 * Workspace_TextDocumentContent_RefreshResult
 */
using Workspace_TextDocumentContent_RefreshResult = Null;
